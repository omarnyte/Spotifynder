...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_spotify_web_api_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_spotify_web_api_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_spotify_web_api_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__navbar__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__related_artists__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bubble_chart__ = __webpack_require__(177);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(178);
...
class BubbleChart {
  ...
  render(relatedArtistsResp) {
    console.log('in bubbleChart', relatedArtistsResp);
    var svg = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]("svg");
    console.log(svg);
    var width = +svg.attr("width");
    var height = +svg.attr("height");

    var format = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* format */](",d");

    var color = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* scaleOrdinal */](__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* schemeCategory20 */]);

    // sets the invisible dimensions of the bubbles container
    var pack = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* pack */]()
    .size([width, height])
    .padding(1.5);

    // sets the test file as the data to be displayed
    __WEBPACK_IMPORTED_MODULE_0_d3__["a" /* csv */]("/data/test.csv", function(d) {
      d.value = +d.value;
      if (d.value) return d;
    }, function(error, classes) {
      if (error) throw error;

      var root = __WEBPACK_IMPORTED_MODULE_0_d3__["c" /* hierarchy */]({children: classes})
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_12_d3_format__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__src_pack_index__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_14__src_category20__["a"]; });
